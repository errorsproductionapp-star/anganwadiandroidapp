...
@Composable
fun ParentHealthObservationScreen(onBack: () -> Unit) {
    Scaffold(
        ...
        Column(
            ...
            Icon(Icons.Default.Favorite, null, tint = ParentPrimary, modifier = Modifier.size(64.dp))
            Spacer(modifier = Modifier.height(16.dp))
            Text("Health Observation", fontSize = 20.sp, fontWeight = FontWeight.Bold, color = ParentTextDark)
