...
@Composable
fun ParentActivityRatingScreen(onBack: () -> Unit) {
    Scaffold(
        ...
        Column(
            ...
            Icon(Icons.Default.StarRate, null, tint = ParentPrimary, modifier = Modifier.size(64.dp))
            Spacer(modifier = Modifier.height(16.dp))
            Text("Activity Rating", fontSize = 20.sp, fontWeight = FontWeight.Bold, color = ParentTextDark)
