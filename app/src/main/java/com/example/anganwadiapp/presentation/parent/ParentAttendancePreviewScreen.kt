...
@Composable
fun ParentAttendancePreviewScreen(onBack: () -> Unit) {
    Scaffold(
        ...
        Column(
            ...
            Icon(Icons.Default.HowToReg, null, tint = ParentPrimary, modifier = Modifier.size(64.dp))
            Spacer(modifier = Modifier.height(16.dp))
            Text("Attendance Status", fontSize = 20.sp, fontWeight = FontWeight.Bold, color = ParentTextDark)
